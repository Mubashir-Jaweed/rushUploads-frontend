      ...
      if (response && response.data.url) {
        ...
        if (reader) {
          while(true) {
            ...
            // Update progress using ref to avoid closure issues
  ...
  return (
    <div>
      ...
      <div className=" w-full h-screen auth-bg flex items-end">
        {isAds && redirectUrl.length > 0 && adBannerUrl.length> 0 ? (
                      ...
                      <div className="flex w-full justify-between items-end">
                        ...
                        <div className="flex justify-center gap-2 items-center ">
                          <a
                            ...
                            disabled={downloadingFiles.has(val.id)}
                          >
                            {downloadingFiles.has(val.id) ? (
                              <>
