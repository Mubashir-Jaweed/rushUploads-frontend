               ...
               <FadeText
                ...
                >
                    ...
                    <div className='max-sm:w-[90%] max-md:w-[75%] max-sm:mt-4 mt-10 w-[60%] flex flex-col justify-center items-center gap-3'>
                        {data.map((val,i)=>(
                            <div key={i} onClick={()=>setTab(i)} className={`${tab == i ? 'h-[120px] max-sm:h-[140px]' : 'h-[60px]'} delay-5ms cursor-pointer acc-cont border border-zinc-500 rounded-[5px] flex flex-col justify-center items-start  w-full p-4`}>
