    ...
    <div className="hover:bg-[#f5f5f57e] bg-[#f5f5f52d] w-full list-card cursor-pointer flex flex-col  justify-center items-center rounded-[8px] p-3">
      ...
      <div className='flex w-full justify-between items-end'>
        <div className='flex justify-start items-center gap-3'>
          <span className=' text-sm font-normal text-zinc-700'>{status} {data.updatedAt.split('T')[0]
          }</span>
        ...
        <div className='flex justify-center items-center '>
          ...
          <span onClick={deleteFile} className='list-btn-title-cont delay-5ms hover:bg-[#32323218] text-stone-800 p-2 rounded-full flex justify-center items-center'>
